///initChar(character, hp, weight, walk_speed, jump_speed, jumps, jump_time, arm_x, arm_y)
...
var arm = argument[8];
var arm_x = argument[9];
var arm_y = argument[10];
...
switch(character) {
	case "TEST":
		...
		char.hp = hp;
		char.weight = weightKgToDec(weight);
